...
export function makeRequest(method, url, body = null, customHeaders = null) {
...
export function makeAuthenticatedRequest(method, url, body, token) {
  const headers = {
...
export function extractMetrics(response, testName) {
  ...
  if (response.headers && response.headers['Server-Timing']) {
