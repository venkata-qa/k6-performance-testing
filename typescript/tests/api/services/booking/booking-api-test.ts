...
import { makeRequest, validateResponse, generateRandomData } from '../../../../utils/helpers.ts';
 ...
 */
export function testCheckAvailability(data) {
 ...
 */
export function testCreateBooking(data) {  const url = getServiceUrl('booking', 'createBooking');
  const bookingData = {
 ...
 */
export function testGetBooking(bookingId) {
 ...
 */
export function testListBookings(data) {
 ...
 */
export function testUpdateBooking(bookingId) {
 ...
 */
export function testCancelBooking(bookingId) {
