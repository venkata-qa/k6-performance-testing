 ...
 */
export function testUploadSequence(data) {  const url = getServiceUrl('genomics', 'uploadSequence');
  const sequenceData = {
 ...
 */
export function testAnalyzeSequence(sequenceId) {
 ...
 */
export function testGetResults(resultId) {
 ...
 */
export function testListSequences(data) {
 ...
 */
function generateMockSequence() {  const bases = ['A', 'T', 'G', 'C'];
  let sequence = '';
  for (let i = 0; i < 100; i++) {
