...
export default function(data) {
  ...
  if (assessmentId) {
    testUpdateAssessment(data.serviceConfig, assessmentId);
    sleep(1);
  }
  
  // Test 4: Submit assessment
  if (assessmentId) {
    testSubmitAssessment(data.serviceConfig, assessmentId);
    sleep(2);
  }
  
  // Test 5: Get results
  if (assessmentId) {
    testGetResults(data.serviceConfig, assessmentId);
    sleep(1);
  }
 ...
 */
export function testCreateAssessment(serviceConfig) {
  const url = getServiceUrl('healthAssessment', 'createAssessment');
 ...
 */
export function testGetAssessment(serviceConfig, assessmentId) {
 ...
 */
export function testUpdateAssessment(serviceConfig, assessmentId) {
 ...
 */
export function testSubmitAssessment(serviceConfig, assessmentId) {
 ...
 */
export function testGetResults(serviceConfig, assessmentId) {
 ...
 */
export function testListAssessments(serviceConfig) {
